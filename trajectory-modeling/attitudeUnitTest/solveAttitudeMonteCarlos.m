function log = solveAttitudeMonteCarlos(mcConfig,numRuns,calcXdots)
    % solveAttitudeMonteCarloSim Runs linearized attitude LQR controller for a 
    % number of specified runs.
    %
    % mcConfig - xlsx file containing attitude model and MC configurations
    ...
    for runIndex = 1:numRuns
        ...
        fprintf('Simulating monte carlo linearized attitude trajectory: Run %d out of %d...\n',runIndex,numRuns)
