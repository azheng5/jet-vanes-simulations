...
%calcAeroBody Wrapper for Rusheer Sheghandi's aero model for calculating 
% aero forces and moments for the nonlinear rocket model. Aero equations 
% are only valid up to roughly 10 degrees angle of attack.
%
...
% MA_b - aero moment in body frame about current CG (Nm)
    ...
    rho = rho * 0.062;% kg/m^3 to lbm/ft^3
